	...
	forval i=1/50{
		...
		quietly{
			...
			*upc
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_19 = mean(err_hat2)
			local MSE_19 = MSE_19
			matrix P[`i',(24*`z'-5)] = `MSE_19'
			drop MSE_19 xb19 fe1 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi
			...
			*upc dma
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_20 = mean(err_hat2)
			local MSE_20 = MSE_20
			matrix P[`i',(24*`z'-4)] = `MSE_20'
			drop MSE_20 xb20 fe1 fe2 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi
			...
			*upc dma calendar
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_21 = mean(err_hat2)
			local MSE_21 = MSE_21
			matrix P[`i',(24*`z'-3)] = `MSE_21'
			drop MSE_21 xb21 fe1 fe2 fe3 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi
			...
			*upc dma period
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_22 = mean(err_hat2)
			local MSE_22 = MSE_22
			matrix P[`i',(24*`z'-2)] = `MSE_22'
			drop MSE_22 xb22 fe1 fe2 fe3 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi
			...
			*upc calendar
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_23 = mean(err_hat2)
			local MSE_23 = MSE_23
			matrix P[`i',(24*`z'-1)] = `MSE_23'
			drop MSE_23 xb23 fe1 fe2 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi			
			...
			*upc period
			...
			gen share_predicted = num / ((nest_inclusive_value^_b[lwns_`z'])*(1+market_inclusive_value)) if e_sample==0
			gen err_hat2 = (share_predicted - shares)*(share_predicted - shares)
			egen MSE_24 = mean(err_hat2)
			local MSE_24 = MSE_24
			matrix P[`i',(24*`z')] = `MSE_24'
			drop MSE_24 xb24 fe1 fe2 num delta_j unique_nest market_inclusive_value nest_inclusive_value share_predicted err_ha* num_in_nest errores mean_xi
...
forval z=1/3{
		...
		*upc
		...
		estadd scalar MSE1=MSE[1,(24*`z'-23)]
		...
		*upc dma
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-22)]
		...
		*upc dma calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-21)]
		...
		*upc dma period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-20)]
		...
		*upc calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-19)]
		...
		*upc period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-18)]
		...
		*upc
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-17)]
		...
		*upc dma
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-16)]
		...
		*upc dma calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-15)]
		...
		*upc dma period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-14)]
		...
		*upc calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-13)]
		...
		*upc period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-12)]
		...
		*upc
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-11)]
		...
		*upc dma
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-10)]
		...
		*upc dma calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-9)]
		...
		*upc dma period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-8)]
		...
		*upc calendar
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-7)]
		...
		*upc period
		...
		estadd scalar APF1=first[4,1]
		estadd scalar APF2=first[4,2]
		estadd scalar MSE1=MSE[1,(24*`z'-6)]
		...
		/*OLS*/
		*upc
		eststo: reghdfe logsj_logs0 price lwns_`z', abs(upc) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z'-5)]
		esttab using `2'/tables/r_19_`z'.csv, stats(N r2 MSE1, labels("Observations" "R-squared" "MSE")) replace

		est clear
		*upc dma
		eststo: reghdfe logsj_logs0 price lwns_`z', abs(upc dma_code) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z'-4)]
		esttab using `2'/tables/r_20_`z'.csv, stats(N r2 MSE1, labels("Observations" "R-squared" "MSE")) replace

		est clear
		*upc dma calendar
		eststo: reghdfe logsj_logs0 price lwns_`z', abs(upc dma_code calendar) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z'-3)]
		esttab using `2'/tables/r_21_`z'.csv, stats(N r2 MSE1, labels("Observations" "R-squared" "MSE")) replace

		est clear
		*upc dma period
		eststo: ivreghdfe logsj_logs0 price lwns_`z', abs(upc dma_code period) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z'-2)]
		esttab using `2'/tables/r_22_`z'.csv, stats(N r2 MSE1, labels("Observations" "R-squared" "MSE")) replace

		est clear
		*upc calendar
		eststo: reghdfe logsj_logs0 price lwns_`z', abs(upc calendar) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z'-1)]
		esttab using `2'/tables/r_23_`z'.csv, stats(N r2 MSE1,  labels("Observations" "R-squared" "MSE")) replace

		est clear
		*upc period
		eststo: reghdfe logsj_logs0 price lwns_`z', abs(upc period) cluster(dma_code)
		estadd scalar MSE1=MSE[1,(24*`z')]
		esttab using `2'/tables/r_24_`z'.csv, stats(N r2 MSE1, labels("Observations" "R-squared" "MSE")) replace
