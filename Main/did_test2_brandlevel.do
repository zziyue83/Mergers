...
/* Fixed Effects */
egen entity_effects = group(brand_code_uc dma_code)
...
egen weights_1 = total(pre_vol), by(brand_code_uc)
egen weights_2 = total(pre_vol), by(dma_code)
egen weights_3 = total(pre_vol), by(brand_code_uc dma_code)
...
est sto NO_FE_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE") replace
...
est sto PM_FE_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product FE") append
...
est sto PMT_FE_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Time FE") append
...
est sto PMT_C_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE") append
...
est sto PMT_t_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends") append
...
est sto NO_FE_M_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Major") append
...
est sto PM_FE_M_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product FE, Major") append


* Product/market and Time Fixed-Effects
reghdfe lprice post_merger_merging post_merger_major [aw = weights_`x'], abs(entity_effects time_effects) vce(cluster dma_code)
est sto PMT_FE_M_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Time FE, Major") append
...
est sto PMT_C_M_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Major") append
...
est sto PMT_t_M_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Major") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, DHHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product FE, DHHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, DHHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, DHHI") append
...
est sto np_D_H_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Naive DHHI & post HHI") append

*No Fixed-Effects naive post-HHI
reg lprice post_merger post_hhi  np_HHI trend [aw = weights_`x'], vce(cluster dma_code)
est sto np_H_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Naive post HHI") append

*No Fixed-Effects naive DHHI
reg lprice post_merger dhhi np_dhhi trend [aw = weights_`x'], vce(cluster dma_code)
est sto np_D_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Naive DHHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Products FE, Naive DHHI & post HHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Products FE, Naive post HHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Products FE, Naive DHHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Naive DHHI & post HHI") append
...
est sto PMT_FE_t_np_D_H_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Naive DHHI & post HHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Naive post HHI") append
...
est sto PMT_FE_t_np_H_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Naive post HHI") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Naive DHHI") append
...
est sto PMT_FE_t_np_D_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Naive DHHI") append
...
est sto NO_FE_d_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Demographics") append
...
est sto PM_FE_d_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Products FE, Demographics") append
...
est sto PMT_FE_d_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Time FE, Demographics") append
...
est sto PMT_C_d_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Demographics") append
...
est sto PMT_t_d_`x'
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, Major, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product FE, Major, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Time FE, Major, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, Major, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, Major, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("No FE, DHHI, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product FE, DHHI, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Time FE, DHHI, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("Calendar FE, DHHI, Demographics") append
...
outreg2 using `2'/brandlevel_did_stata_`3'_`x'.txt, stats(coef se pval) ctitle("DMA/Product Trends, DHHI, Demographics") append
...
esttab tabl1 tabl2 using `2'/brandlevel_did_stata_table_`3'.tex, replace se r2 ar2 title("Reduced Form Price Effects") mtitles("DMA/Product FE" "DMA/Product, Demographics") addnote("Data frequency: `3'.")
