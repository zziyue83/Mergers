...
conversion_map = spm.get_conversion_map(code, info_dict["FinalUnits"])
area_month_upc = spm.aggregate_movement(code, years, groups, modules, "month", conversion_map, info_dict["DateAnnounced"], info_dict["DateCompleted"])
