...
def preModelData(products, quarterOrMonth, mergingyear, mergingquarterormonth):
    ...
    for product in products:
        ...
        for data_chunk in chunks:
            ...
            data_chunk['involved'] = np.where((data_chunk['owner company'] == 'Mars') | (data_chunk['owner company'] == 'Wrigley'), 1, 0)
...
preModelData(products, quarterOrMonth, mergingyear, mergingquarterormonth)
